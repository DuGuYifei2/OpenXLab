...
<html lang="en">
	...
	<body> 
		...
		<div id="page" class="page font--jakarta">
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="index.html" class="logo-black"><img src="images/logo-blue.png" alt="logo"></a>
	    					</div>
	    					

	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="index.html" class="logo-white"><img src="images/logo-blue-white.png" alt="logo"></a>
	    					</div>
					...
					<div class="row justify-content-center">	
						...
						<div class="col-md-9 col-lg-8">
							<div class="page-404-txt text-center">
								...
								<!-- Button -->
								<a href="index.html" class="btn btn--theme hover--theme">Back to home</a>	
			...
			<!-- FOOTER-11
			============================================= -->
			<footer id="footer-11" class="bg--white-300 pt-50 footer">
				<div class="container">
					...
					<div class="bottom-footer">
						<div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
							...
							<!-- FOOTER COPYRIGHT -->
							<div class="col">
								<div class="footer-copyright"><p class="p-sm">&copy; 2014-2023 Martex Labs, Inc.</p></div>
							</div>
							...
							<div class="col">
								<ul class="bottom-footer-list ico-15 text-end">
									...
									<li class="footer-list-divider"><p><span class="flaticon-minus"></span></p></li>
